/-
  BPF cnum ALU verification task: Bitwise OR (64-bit, cnum domain)
  Operator: ALU64_OR
  ...
  bitwise OR (dst | src) on two abstract register states in the
...
/-- Compute the optimal abstract state for Bitwise OR (64-bit, cnum domain). -/

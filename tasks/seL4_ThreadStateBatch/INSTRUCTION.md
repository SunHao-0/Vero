# Task: Thread State Batch Setter

**Source**: seL4 thread_state bitfield, include/object/structures_64.bf; slowpath setters vs fastpath mset_ variants (src/fastpath/fastpath.c)

/-
  BPF cnum ALU verification task: Left Shift (64-bit, cnum domain)
  Operator: ALU64_LSH
  ...
  logical left shift (dst << src), shift amount < 64 on two abstract register states in the
...
/-- Compute the optimal abstract state for Left Shift (64-bit, cnum domain). -/

/-
  BPF cnum ALU verification task: Bitwise XOR (64-bit, cnum domain)
  Operator: ALU64_XOR
  ...
  bitwise XOR (dst ^ src) on two abstract register states in the
...
/-- Compute the optimal abstract state for Bitwise XOR (64-bit, cnum domain). -/

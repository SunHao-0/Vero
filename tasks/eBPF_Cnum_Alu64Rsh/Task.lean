/-
  BPF cnum ALU verification task: Logical Right Shift (64-bit, cnum domain)
  Operator: ALU64_RSH
  ...
  logical right shift (dst >> src), shift amount < 64 on two abstract register states in the
...
/-- Compute the optimal abstract state for Logical Right Shift (64-bit, cnum domain). -/

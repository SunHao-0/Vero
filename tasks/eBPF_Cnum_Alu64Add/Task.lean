/-
  BPF cnum ALU verification task: Addition (64-bit, cnum domain)
  Operator: ALU64_ADD
  ...
  wrapping 64-bit addition (dst + src) on two abstract register states in the
...
/-- Compute the optimal abstract state for Addition (64-bit, cnum domain). -/

# Task: schedule-forest merge with weighted node accumulation

**Source**: synthetic composite modeled on seL4 scheduling-state surgery (src/object/schedcontext.c, src/kernel/thread.c); no single upstream routine
...
The provided theorem states that your implementation satisfies all postconditions. You may add helper lemmas in AUX.

# Task: MDB subtree rotation preserving traversal order

**Source**: models the seL4 mapping database (MDB), src/object/cnode.c (mdb_node manipulation in cteInsert/cteDelete)

# Task: CNode guard compression

**Source**: models seL4 CSpace resolution, src/kernel/cspace.c (resolveAddressBits); CNode guard/radix capabilities, src/object/cnode.c

/-
  BPF cnum ALU verification task: Bitwise AND (64-bit, cnum domain)
  Operator: ALU64_AND
  ...
  bitwise AND (dst & src) on two abstract register states in the
...
/-- Compute the optimal abstract state for Bitwise AND (64-bit, cnum domain). -/

/-
  BPF cnum ALU verification task: Subtraction (64-bit, cnum domain)
  Operator: ALU64_SUB
  ...
  wrapping 64-bit subtraction (dst - src) on two abstract register states in the
...
/-- Compute the optimal abstract state for Subtraction (64-bit, cnum domain). -/

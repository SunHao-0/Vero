...
def {{LEAN_FUNC_NAME}} (demanded : BitVec 64) (a b : KnownBits)
    : BitVec 64 × BitVec 64 :=
-- === END: SPEC ===
...
theorem {{LEAN_FUNC_NAME}}_correct (demanded : BitVec 64) (a b : KnownBits)
    (ha : validKB a) (hb : validKB b) :
    let (dA, dB) := {{LEAN_FUNC_NAME}} demanded a b

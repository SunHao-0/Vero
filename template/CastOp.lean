/-
  BPF cast verification task: {{OPERATION_TITLE}}
  Operator: {{OPERATOR_NAME}}
  Source: Linux eBPF verifier, kernel/bpf/verifier.c (coerce_reg_to_size, coerce_reg_to_size_sx)

  Compute the optimal abstract state for the result of
  {{LEAN_OP_DESCRIPTION}} on a single abstract register state,
